...
FORWARDER2(sim_dev_set_address, void, void, struct SimDevice *,
	   unsigned char *);
FORWARDER2(sim_dev_set_mtu, void, void, struct SimDevice *, int);
FORWARDER2(sim_dev_create_packet, nvoid, struct SimDevicePacket,
...
FORWARDER3(sim_sock_recvmsg, nvoid, ssize_t, struct SimSocket *,
	   struct msghdr *, int);
FORWARDER3(sim_sock_sendmsg, nvoid, ssize_t, struct SimSocket *,
	   const struct msghdr *, int);
FORWARDER3(sim_sock_getsockname, nvoid, int, struct SimSocket *,
	   struct sockaddr *, int *);
FORWARDER3(sim_sock_getpeername, nvoid, int, struct SimSocket *,
	   struct sockaddr *, int *);
FORWARDER3(sim_sock_bind, nvoid, int, struct SimSocket *,
	   const struct sockaddr *, int);
FORWARDER4(sim_sock_connect, nvoid, int, struct SimSocket *,
...
FORWARDER3(sim_sock_accept, nvoid, int, struct SimSocket *,
	   struct SimSocket **, int);
FORWARDER3(sim_sock_ioctl, nvoid, int, struct SimSocket *, int, char *);
FORWARDER5(sim_sock_setsockopt, nvoid, int, struct SimSocket *, int, int,
	   const void *, int);
FORWARDER5(sim_sock_getsockopt, nvoid, int, struct SimSocket *, int, int,
	   void *, int *);
...
FORWARDER4(sim_sys_file_read, nvoid, int, const struct SimSysFile *, char *,
	   int, int);
FORWARDER4(sim_sys_file_write, nvoid, int, const struct SimSysFile *,
	   const char *, int, int);
...
struct SimTask *sim_task_start(void (*callback) (void *), void *context)
{
	struct SimTaskTrampolineContext *ctx =
		sim_malloc(sizeof(struct SimTaskTrampolineContext));
